...
report](articles/NeighborFinder_technical_report.md). For an illustrated
example, please refer to the
[vignette](articles/NeighborFinder_vignette.md).
...
With this output, a network can be created with
[`visualize_network()`](reference/visualize_network.md).
