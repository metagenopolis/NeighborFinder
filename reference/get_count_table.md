...
Conversion to count table function with prevalence filter (Extracted
from OneNet package)
...
- abund.table:
  ...
  Dataframe. Abundance table, it should have the bacterial species names
  as first column
...
- prev.min:
  ...
  Numeric. The value is between 0 and 1 and corresponds to the minimal
  prevalence threshold of bacterial species to keep in the final table
...
- msp:
  ...
  String vector. It indicates bacterial species names, if they are not
  specified in the abundance table first column
