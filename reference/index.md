...
- [`get_count_table()`](get_count_table.md) : Conversion to count table
  function with prevalence filter
...
- [`result_example`](result_example.md) : result_example
...
- [`simulate_from_ecdf()`](simulate_from_ecdf.md) : Simulate data
  Generates synthetic count data based on empirical cumulative
  distribution (ecdf) of real count data
- [`taxo`](taxo.md) : taxo
