...
#### 3)	Post-processing: Filtering the results
...
<center>Figure 3: Evaluation of performance procedure</center>
<br>
...
<center>Figure 4: Performance results of NeighborFinder</center>
<br>
...
```{r fig5, echo=FALSE, fig.align='center', out.width="25%"}
knitr::include_graphics("~/neighborfinder/vignettes/Technical_report_figures/fig5.jpg")
```

<center>Figure 5: Impact of the sample size on NeighborFinder performance</center>
<br>

The performance results from synthetic data show here that a sample size n greater than or equal to 250 is recommended to ensure a good performance (F1 > 50%).
